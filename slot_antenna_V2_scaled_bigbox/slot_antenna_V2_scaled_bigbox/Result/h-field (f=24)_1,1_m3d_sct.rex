...
<MetaResultFile version="20211011" creator="Solver HFTD - Field 3DFD Monitor">
  ...
  <SimulationProperties fieldname="surface current (f=24) [1]" frequency="24" encoded_unit="&amp;U:A^1.:m^-1" quantity="surf_current" fieldtype="Surface current" fieldscaling="PEAK" dB_Amplitude="20"/>
  ...
  <AuxResultFile/>
  <FieldFreeNodes/>
  <SurfaceFieldCoefficients filename="h-field (f=24)_1,1_m3d_sct.coe"/>
  <UnitCell/>
